...
class StatusDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Booking::factory()->create(['user_id'=>$u->user_id,'ruangan_id'=>$r->ruangan_id,'hari_tanggal'=>now('Asia/Jakarta')->addDays(2)->utc(),'jam'=>'09:00:00','status'=>StatusBooking::SUBMITTED->value]);

        // Pemesanan menunggu & diterima
        $b = Booking::factory()->create(['user_id'=>$u->user_id,'ruangan_id'=>$r->ruangan_id,'hari_tanggal'=>now('Asia/Jakarta')->addDays(3)->utc(),'jam'=>'10:00:00','status'=>StatusBooking::SUBMITTED->value]);
