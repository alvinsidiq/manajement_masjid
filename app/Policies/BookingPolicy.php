...
class BookingPolicy
{
    ...
    public function update(User $u, Booking $b): bool { return $b->user_id === $u->user_id && in_array($b->status->value,['hold','proses']); }
    public function delete(User $u, Booking $b): bool { return $b->user_id === $u->user_id && in_array($b->status->value,['hold','proses']); }
}
